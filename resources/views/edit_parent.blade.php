{{-- resources/views/edit_parent.blade.php --}}
...
<body>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content pt-5 mt-5">
                <section class="section mb-5 pb-1 px-0">
                    <div class="col-12">
                        <div class="card">
                            <form action="{{ route('parent.update', $parent->id) }}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-6 px-0">
                                        ...
                                        <input type="text" id="parent-name" name="parent_name" class="form-control" value="{{ old('parent_name', $parent->name) }}" required placeholder="e.g. MARY DOE" oninput="this.value = this.value.toUpperCase()">
                                    ...
                                    <div class="form-group col-md-6 px-0">
                                        ...
                                        <input type="email" id="parent-email" name="parent_email" class="form-control" value="{{ old('parent_email', $parent->email) }}" required placeholder="e.g. parent@example.com">
                                        <div class="valid-feedback">Looks good!</div>
                                    ...
                                    <div class="form-group col-md-6 px-0">
                                        ...
                                        <input type="text" id="parent-phone" name="parent_phone" class="form-control" value="{{ old('parent_phone', $parent->phone) }}" placeholder="e.g. +1234567890">
                                    </div>

                                    <div class="form-group col-md-6 px-0">
                                        <label>Password <small>(Leave blank to keep current)</small></label>
                                        <input type="password" name="password" class="form-control" placeholder="Enter new password">
                                        <div class="invalid-feedback">Please provide a password if changing.</div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            let isPrefilled = {{ $parent->students->count() > 0 ? 'true' : 'false' }}; // Prefilled if editing
            ...
            // On student selection, fetch and prefill guardian details only if not prefilled
