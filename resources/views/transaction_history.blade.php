                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Transaction History for {{ $student->name }} ({{ $student->admission_no }})</h4>
                            ...
                            <div class="collapse" id="filterCollapse">
                                <div class="card-body pb-0">
                                    <form action="{{ route('payment.history', $student->id) }}" method="GET" class="row">
                                        ...
                                        <div class="form-group col-md-12 d-flex align-items-end">
                                            ...
                                            <a href="{{ route('payment.history', $student->id) }}" class="btn btn-light">
                            ...
                            <div class="card-body">
                                ...
                                @if(request('filter_section') || request('filter_term') !== null ||
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="active-filters">
                                        ...
                                        @endif
                                        <a href="{{ route('payment.history', $student->id) }}" class="btn btn-sm  btn-outline-danger">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="transactions-table" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>S/N</th>
                                                <th>Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('bursar.payment.receipt', $payment->id) }}" class="btn btn-sm m-1 btn-success" target="_blank">Print Receipt</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
