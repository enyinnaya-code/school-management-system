            ...
            <div class="main-content pt-5 mt-5">
                <section class="section mb-5 pb-5 px-0">
                    <div class="col-12">
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap" style="gap:6px;">
                                        ...
                                        <a href="{{ route('student.result.upload', $nextStudent->id) }}"
                                            class="btn btn-primary btn-sm" title="Go to {{ $nextStudent->name }}">
                        ...
                        <form method="POST" action="{{ route('results.savePrimaryStudent', $student->id) }}"
                                        ...
                                        <table class="table table-bordered subject-table" id="cognitiveTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="2" class="text-center" style="background:#dbeafe;">
                                                        1st Half
                                                        <small class="d-block text-muted font-weight-normal">(Max:
                                                            30)</small>
                                                    </th>
                                                    ...
                                                    <th colspan="2" class="text-center" style="background:#fef9c3;">
                                                        Final Result
                                                        <small class="d-block text-muted font-weight-normal">(Max:
                                                            100)</small>
                                                    </th>
                                                    <th class="text-center align-middle"
                                                        ...
                                                        Total
                                                        <small
                                                            class="d-block text-muted font-weight-normal">(Live)</small>
                                                    </th>
                                                ...
                                                <tr class="result-row">
                                                    ...
                                                    <td style="background:#f8fbff;">
                                                        <input type="number"
                                                            ...
                                                            data-max="30" data-course="{{ $subject->id }}"
                                                            data-half="first"
                                                            value="{{ $r?->first_half_obtained ?? '' }}" min="0"
                                                            max="30" step="0.5" placeholder="0–30">
                                                    </td>
                                                    ...
                                                    <td style="background:#f8fdf9;">
                                                        <input type="number"
                                                            ...
                                                            data-max="70" data-course="{{ $subject->id }}"
                                                            data-half="second"
                                                            value="{{ $r?->second_half_obtained ?? '' }}" min="0"
                                                            max="70" step="0.5" placeholder="0–70">
                                                    </td>
                                                    ...
                                                    <td style="background:#fffef5;">
                                                        <input type="number"
                                                            ...
                                                            data-max="100" data-course="{{ $subject->id }}"
                                                            value="{{ $r?->final_obtained ?? '' }}" min="0" max="100"
                                                            step="0.5" placeholder="Auto" readonly
                                                    ...
                                                    <td style="background:#f5f3ff;" class="text-center align-middle">
                                                        <strong class="live-total text-purple"
                                                            ...
                                                            {{ $r && ($r->first_half_obtained !== null ||
                                                            $r->second_half_obtained !== null)
                                                            ? number_format(($r->first_half_obtained ?? 0) +
                                                            ($r->second_half_obtained ?? 0), 1)
                                                            : '—' }}
                                                        </strong>
                                                    </td>
                                                    ...
                                                    {{-- Live Grade --}}
                                                    <td style="background:#f5f3ff;" class="text-center align-middle">
                                                        <input type="hidden" name="results[{{ $subject->id }}][grade]"
                                                            class="grade-hidden-input" value="{{ $r?->grade ?? '' }}">
                                                    ...
                                                    <td style="background:#fdf2f8;">
                                                        <input type="text"
                                                            ...
                                                            placeholder="e.g. Good" maxlength="50">
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center"><span
                                                            class="badge badge-success px-2">A</span></td>
                                                    <td class="text-center">70 – 100</td>
                                                    <td>Excellent</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><span
                                                            class="badge badge-primary px-2">B</span></td>
                                                    <td class="text-center">60 – 69</td>
                                                    <td>Very Good</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><span class="badge badge-info px-2">C</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-center"><span
                                                            class="badge badge-warning px-2">D</span></td>
                                                    <td class="text-center">45 – 49</td>
                                                    <td>Pass</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><span
                                                            class="badge badge-secondary px-2">E</span></td>
                                                    <td class="text-center">40 – 44</td>
                                                    <td>Below Average</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><span
                                                            class="badge badge-danger px-2">F</span></td>
...
">
        ...
        <div style="display:flex; gap:8px;">
            @if($prevStudent ?? null)
            <a href="{{ route('student.result.upload', $prevStudent->id) }}" class="btn btn-outline-primary"
            ...
            @if($nextStudent ?? null)
            <a href="{{ route('student.result.upload', $nextStudent->id) }}" class="btn btn-primary"
