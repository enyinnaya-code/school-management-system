...
<body>
    ...
    <div id="app">
        ...
        'term_id'    => $currentTerm->id,
    ]) }}" class="btn btn-outline-secondary btn-sm" title="Back to student list">
                                            <i class="fas fa-list mr-1"></i> Back to List
                                        </a>

                                        {{-- Previous student --}}
                                        @if($prevStudent ?? null)
                                        <a href="{{ route('student.result.upload', $prevStudent->id) }}?session_id={{ $currentSession->id }}&term_id={{ $currentTerm->id }}"
                                       ...
                                       {{-- Next student --}}
@if($nextStudent ?? null)
<a href="{{ route('student.result.upload', $nextStudent->id) }}?session_id={{ $currentSession->id }}&term_id={{ $currentTerm->id }}"
                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table table-bordered align-middle" id="resultsTable">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th colspan="2" style="background:#fef9c3;">
                                                        Total <span class="badge badge-warning text-dark ml-1">Max:
                                                            100</span>
                                                    </th>
                                                    <th rowspan="2" class="align-middle text-center"
                                                        style="min-width:70px; background:#f3e8ff;">
                                                        Grade
                                                    </th>
                                                    <th rowspan="2" class="align-middle" style="min-width:160px;">
                                                        Comment</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="item-row">
                                                    ...
                                                    {{-- Comment --}}
                                                    <td>
                                                        <input type="text" name="results[{{ $subject->id }}][comment]"
                                ...
                                <div class="mt-4">
                                    ...
                                    <table class="table table-sm table-bordered" style="max-width:420px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center"><span class="badge badge-success px-2">A</span>
                                                </td>
                                                <td class="text-center">70 – 100</td>
                                                <td>Excellent</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center"><span class="badge badge-primary px-2">B</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center"><span class="badge badge-warning px-2">D</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center"><span class="badge badge-danger px-2">F</span>
                                                </td>
...
">
        ...
        <div style="display:flex; gap:8px;">
            @if($prevStudent ?? null)
            <a href="{{ route('student.result.upload', $prevStudent->id) }}?session_id={{ $currentSession->id }}&term_id={{ $currentTerm->id }}"
                class="btn btn-outline-primary" title="{{ $prevStudent->name }}">
                <i class="fas fa-chevron-left mr-1"></i>
            ...
            @if($nextStudent ?? null)
           <a href="{{ route('student.result.upload', $nextStudent->id) }}?session_id={{ $currentSession->id }}&term_id={{ $currentTerm->id }}" class="btn btn-primary"
  ...
  @if($nextStudent ?? null)
var nextStudentUrl = "{{ route('student.result.upload', $nextStudent->id) }}?session_id={{ $currentSession->id }}&term_id={{ $currentTerm->id }}";
@endif
